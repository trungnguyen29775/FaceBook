    ...
    switch(action.type)
    {
        ...
        case HIDE_MESS_WINDOW:
            {                
                return{
                    ...messState,
                    messWindowArray:messState.messWindowArray.slice(0,action.payload).concat(messState.messWindowArray.slice(action.payload+1,messState.messWindowArray.length))
                }
            }
